...
class Interface:
    def __init__(self, janela):
        self.root = janela
        self.root.title("Cálculo de Fatura Águas Guariroba")
        self.root.geometry("400x400") 
        self.root.config(bg="#01FDDB")  
    ...
    def criar_widgets(self):
        self.login_frame = tk.Frame(self.root, bg="#01FDDB")
    ...
    def show_consumo_frame(self):
        ...
        self.consumo_frame = tk.Frame(self.root, bg="#01FDDB")
    ...
    def exibir_fatura(self, fatura):
        self.resultado_frame = tk.Frame(self.root, bg="#f0f0f0")
        ...
        valor_esgoto_label = tk.Label(self.resultado_frame, text=f"Valor do Esgoto: R$ {fatura.valor_egoto}", font=("Arial", 14), bg="#f0f0f0")
        valor_esgoto_label.grid(row=1, column=0, sticky="w", padx=10, pady=10)

        valor_total_label = tk.Label(self.resultado_frame, text=f"Valor Total da Fatura: R$ {fatura.valor_total}", font=("Arial", 14, "bold"), bg="#f0f0f0", fg="#4CAF50")
